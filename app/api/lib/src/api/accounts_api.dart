...
class AccountsApi {
  ...
  Future<Response<String>> completeOnboarding({
    ...
    final _path = r'/onboarding/complete';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> getUserByUid({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/accounts/id/{id}'.replaceAll(
        '{' r'id' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> getUserByUsername({
    ...
    final _path = r'/accounts/username/{username}'.replaceAll(
        '{' r'username' '}',
