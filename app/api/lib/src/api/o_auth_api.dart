...
class OAuthApi {
  ...
  Future<Response<User>> appleAuth({
    required AppleOauthPayload appleOauthPayload,
    ...
    try {
      const _type = FullType(AppleOauthPayload);
      _bodyData =
          _serializers.serialize(appleOauthPayload, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> googleAuth({
